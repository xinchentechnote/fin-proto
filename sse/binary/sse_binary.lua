...
local fields = {
    ...
    new_order_single_side = ProtoField.string("new_order_single.side", "Side"),
    ...
    new_order_single_ord_type = ProtoField.string("new_order_single.ord_type", "OrdType"),
    new_order_single_time_in_force = ProtoField.string("new_order_single.time_in_force", "TimeInForce"),
    ...
    order_cancel_side = ProtoField.string("order_cancel.side", "Side"),
    ...
    confirm_exec_type = ProtoField.string("confirm.exec_type", "ExecType"),
    ...
    confirm_side = ProtoField.string("confirm.side", "Side"),
    ...
    confirm_ord_type = ProtoField.string("confirm.ord_type", "OrdType"),
    confirm_time_in_force = ProtoField.string("confirm.time_in_force", "TimeInForce"),
    confirm_ord_status = ProtoField.string("confirm.ord_status", "OrdStatus"),
    ...
    report_exec_type = ProtoField.string("report.exec_type", "ExecType"),
